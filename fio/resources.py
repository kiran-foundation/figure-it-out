...
# IMAGE_BASE_FOLDER = "../static/images"  # WEB

IMAGE_BASE_FOLDER = "C:\\Users\\Dell\\PycharmProjects\\figure-it-out\\static\\images"  # WINDOWS
...
body_type_desc_dict = {'ideal_figure': 'Hey dear your the lucky one to excess all kind of styles only thing one thing should consider is your height',
                       ...
                       'triangle': 'Wear bright scoop-neck and boat-neck tops. This will make your shoulders look '
                                   'wider. '
                                   'Emphasise your shoulders and bust to balance your silhouette. Accentuate your '
                                   'top half – wear bright '
                                   'colours and accessories, prints and mix your textures and volumes. Tone down '
                                   'your lower half – keep '
                                   'things discrete with dark colours and neutrals. Choose wide-legged, straight-cut '
                                   'and flared trousers '
                       ...
                       'rectangle': 'curves. Pick skirts and dresses that are cinched at the waist. Opt for fitted, '
                                    'structured blazers and '
                                    'jackets. Look for straight, wide-legged and flared trousers and jeans (go '
                                    'high-waisted if you want a slim fit.',
                       'diamond': 'you should dress in such a way to hide your'
                                  'tummy by jackets, dupattas or draping style dress.',
                       'oval': 'Opt for silhouettes without structured waistlines to take focus away from the '
                               'mid-section. '
                               'Choose bust-defining tops in dark colours and diagonal/vertical stripes. Your Power '
                               'Pieces: Go for a '
                               'V-neck or a round neck and peplum tops. Pick high-waisted, slim fit and straight-leg '
                               'trousers and '
